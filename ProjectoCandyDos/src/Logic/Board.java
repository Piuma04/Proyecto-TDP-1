...
public class Board {
    ...
    /**
     * Sets the entity of block at (column, row) to new entity.
     * associates to the GUI, the entity.
     * mostly used for creation.
     * 
     * @param row
     * @param column
    ...
    /**
     * Sets the entity of block at (column, row) to new entity
     * AND changes the position of the entity.
     * 
     * @param row
     * @param column
     * @param entity
    ...
    /**
     *  Given a block, checks the column in search of a block
     *  with a movable entity. Stops and returns null if non
     *  {@link Interfaces.Swappable} with candy is found.
     *  
     * @param block
     * @return entity above in the same column that is not empty. null if non movable entity found.
     */
