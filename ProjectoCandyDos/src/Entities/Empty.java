...
public class Empty extends Entity {
    public Empty(int rowPosition, int columnPosition) { super(rowPosition, columnPosition, Colour.NONE); }
    ...
    // @Override public void changePosition(int newRow, int newColumn) { row =
    // newRow; column = newColumn; }
